export default {
  ...
  progressView: {
    ...
    activeDexTitle: "Pokédex Attivo",
    globalTitle: "Panoramica Progresso Globale",
    globalSubtitle: "Riepilogo consolidato di tutti i tuoi giochi e specie catturate in MyPokeLog.",
    uniqueSpecies: "SPECIE UNICHE",
    gamesCompleted: "GIOCHI COMPLETATI",
    totalCatches: "CATTURE TOTALI",
    uniqueSpeciesCardTitle: "Collezione Globale Specie (1..1025)",
    uniqueSpeciesHint: "Hai registrato {count} delle 1025 specie uniche di Pokémon ({pct}% del totale nazionale).",
    gamesProgressTitle: "Progresso per Edizione & Gioco",
    gamesCompletedCount: "{count} completati",
    completedBadge: "100% COMPLETATO",
    nextMilestone: "PROSSIMO TRAGUARDO",
    remainingText: "Te ne mancano {count} per raggiungere {target}.",
